...
import eu.tutorials.a7_minutesworkoutapp.databinding.DialogCutomeBackConfermationBinding
import java.util.*
...
// changing the upcoming exercise label and name visibility.)
    ...
    private fun customDialogForBackButton() {
        ...
        //create a binding variable
         val dialogBinding =DialogCutomeBackConfermationBinding.inflate(layoutInflater)
